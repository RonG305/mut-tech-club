...
const WorkShops = () => {
    return (
        ...
        className='bg-slate-800 rounded-md px-3 py-4 w-96 shadow-lg shadow-slate-700 text-slate-300'>
    ...
    <div>
        <div>
            ...
            <AnimatePresence>
                ...
                <Seminars key='Seminars' />
                <Trainings key='Trainings' />
                <MemberShipProgram key='MemberShipProgram' />
                <Hackerthons key='Hackerthons' />
            </AnimatePresence>
            </div>
